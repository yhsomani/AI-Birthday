...
class DispatchAttemptRecordMappersTest {
    @Test
    fun entityMapsToPureDispatchAttempt() {
    ...
    @Test
    fun unknownRawEntityValuesMapToUnknownEnums() {
    ...
    @Test
    fun pureDispatchAttemptMapsToEntityRawValues() {
