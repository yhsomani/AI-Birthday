 ...
 * @platform iOS
 */
export interface StackHeaderInlineItemIOS extends StackHeaderBaseItemIOS, SupportsMenuIOS {
    /**
 ...
 */
export type StackHeaderSpacerItemIOS = StackHeaderFixedSpacerItemIOS | StackHeaderFlexibleSpacerItemIOS;
...
export interface StackHeaderConfigPropsIOS {
     ...
     * @platform iOS
     */
    leadingItems?: (StackHeaderInlineItemIOS | StackHeaderInlineCustomItemIOS | StackHeaderSpacerItemIOS)[] | undefined;
    /**
     ...
     * @platform iOS
     */
    trailingItems?: (StackHeaderInlineItemIOS | StackHeaderInlineCustomItemIOS | StackHeaderSpacerItemIOS)[] | undefined;
    /**
...
export {};
//# sourceMappingURL=StackHeaderConfig.ios.types.d.ts.map