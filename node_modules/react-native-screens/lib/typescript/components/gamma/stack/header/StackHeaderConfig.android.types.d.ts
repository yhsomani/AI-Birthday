...
export type StackHeaderToolbarMenuItemShowAsActionAndroid = 'always' | 'alwaysWithText' | 'ifRoom' | 'ifRoomWithText' | 'never';
...
export type StackHeaderToolbarMenuItemTypeAndroid = 'action' | 'toggle' | 'automatic';
export interface StackHeaderToolbarMenuItemAndroid extends StackHeaderToolbarMenuItemBaseAndroid {
    /**
...
export interface StackHeaderToolbarMenuAndroid extends StackHeaderToolbarMenuItemBaseAndroid, StackHeaderToolbarMenuBaseAndroid {
    /**
...
export interface StackHeaderConfigCommandsAndroid {
     ...
     *        restored.
     */
    setToolbarMenuElementOptions: (id: string, options: StackHeaderToolbarMenuElementOptionsAndroid) => void;
}
