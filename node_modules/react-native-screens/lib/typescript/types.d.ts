...
import type { BlurEffect, Direction, ScrollEdgeEffect, UserInterfaceStyle } from './components/shared/types';
...
export interface ScreenProps extends ViewProps {
     ...
     */
    onHeaderHeightChange?: ((e: NativeSyntheticEvent<HeaderHeightChangeEventType>) => void) | undefined;
    /**
     ...
     */
    onTransitionProgress?: ((e: NativeSyntheticEvent<TransitionProgressEventType>) => void) | undefined;
    /**
     ...
     * Defaults to `[1.0]`.
     */
    sheetAllowedDetents?: number[] | 'fitToContents' | 'medium' | 'large' | 'all' | undefined;
    /**
     ...
     */
    sheetLargestUndimmedDetentIndex?: number | 'none' | 'last' | 'medium' | 'large' | 'all' | undefined;
    /**
...
export interface ScreenStackProps extends ViewProps, GestureProps {
     ...
     */
    onFinishTransitioning?: ((e: NativeSyntheticEvent<TargetedEvent>) => void) | undefined;
...
export interface SearchBarProps {
     ...
     */
    autoCapitalize?: 'systemDefault' | 'none' | 'words' | 'sentences' | 'characters' | undefined;
    /**
     ...
     * @platform ios
     */
    onCancelButtonPress?: ((e: NativeSyntheticEvent<TargetedEvent>) => void) | undefined;
    /**
     * A callback that gets called when the text changes. It receives the current text value of the search bar.
     */
    onChangeText?: ((e: NativeSyntheticEvent<TextInputFocusEventData>) => void) | undefined;
    /**
     ...
     */
    onSearchButtonPress?: ((e: NativeSyntheticEvent<TextInputFocusEventData>) => void) | undefined;
    /**
