...
export function PeopleScreen({ navigation }: Props) {
  ...
  // ⚡ Bolt: Defer search query updates to avoid blocking the main thread during typing
  // This prevents expensive filtering and re-renders on every single keystroke.
