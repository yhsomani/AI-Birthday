...
export function PeopleScreen({ navigation }: Props) {
  ...
  // ⚡ Bolt: Defer search query updates to prioritize main thread responsiveness.
  // Reduces text input blocking during rapid typing when filtering large fixture lists.
