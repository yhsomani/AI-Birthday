...
export function PeopleScreen({ navigation }: Props) {
  ...
  // ⚡ Bolt: Defer search query updates to prevent the expensive list filtering
  // below from blocking the main UI thread during rapid typing.
  // Impact: Keeps the search input responsive and prevents frame drops on large lists.
