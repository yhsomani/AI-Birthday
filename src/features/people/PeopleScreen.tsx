...
export function PeopleScreen({ navigation }: Props) {
  ...
  // ⚡ Bolt: Defer search query state to prevent UI blocking
  // This defers the expensive array filtering computation to a background task,
  // preventing the main UI thread from dropping frames during rapid typing.
  // Impact: Reduces UI lag and improves perceived performance during search input.
