...
export function PeopleScreen({ navigation }: Props) {
  ...
  // ⚡ Bolt: Defer search query state to prevent expensive list filtering
  // from blocking the main UI thread during rapid typing.
  // Impact: Keeps the text input responsive when the list grows large.
