...
export function PeopleScreen({ navigation }: Props) {
  ...
  // ⚡ Bolt Optimization: Wrap search query with useDeferredValue
  // Expected Impact: Prevents main UI thread blocking during rapid typing
  // by delegating the heavy array filtering computation to a background task,
  // significantly improving text input responsiveness on large lists.
