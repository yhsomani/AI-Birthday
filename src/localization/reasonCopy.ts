...
export const safeReasonMessageKeys: Record<SafeReasonCode, TranslationKey> = {
  ...
  'phone-state-permission-denied': 'live.reason.permissionDenied',
  'phone-state-permission-permanently-denied':
    'live.reason.permissionPermanentlyDenied',
  'sms-permission-denied': 'live.reason.permissionDenied',
  ...
  'system-composer-outcome-unknown': 'live.reason.systemComposerOutcomeUnknown',
  'system-composer-unavailable': 'live.reason.systemComposerUnavailable',
  ...
  'template-promotional-content': 'live.reason.templatePromotionalContent',
  'template-sensitive-content': 'live.reason.templateSensitiveContent',
  'template-tracking-not-allowed': 'live.reason.templateTrackingNotAllowed',
  ...
  'template-language-mismatch': 'live.reason.templateLanguageMismatch',
