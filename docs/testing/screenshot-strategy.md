...
- Expand large-font screenshot variants beyond the startup, Home, and Messages pilots.
- Add Hindi screenshot variants for text-heavy screens.
- Expand baselines beyond the startup, Home, and Messages pilots to the primary and contextual screens listed above.
