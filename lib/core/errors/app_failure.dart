...
class AppFailure implements Exception {
  ...
  bool get isRetryable => switch (code) {
    ...
    AppFailureCode.deliveryFailed => true,
    _ => false,
  };
  ...
  const AppFailure.credentialMissing({String? action})
    : this(
        ...
        detail:
            'Add your own Gemini API key, or use on-device AI when available.',
  ...
  const AppFailure.timeout()
    : this(AppFailureCode.aiTimeout, message: 'AI request timed out');
