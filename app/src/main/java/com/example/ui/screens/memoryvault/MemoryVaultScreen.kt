...
fun MemoryVaultScreen(
    ...
    var itemToDelete by remember { mutableStateOf<MemoryNoteEntity?>(null) }
    ...
    itemToDelete?.let { note ->
        AlertDialog(
            ...
            text = { Text(stringResource(R.string.memory_vault_delete_confirm_body)) },
            confirmButton = {
                TextButton(
                    onClick = {
