...
import com.example.ui.components.RelateAIBottomNavigation
import com.example.ui.components.RelateAINavigationRail
    ...
    if (isTablet) {
        Scaffold(
            ...
            Row(modifier = Modifier.fillMaxSize()) {
                RelateAINavigationRail(selectedTab = selectedTab, onTabSelected = { selectedTab = it })
        ...
        Scaffold(
            bottomBar = { RelateAIBottomNavigation(selectedTab = selectedTab, onTabSelected = { selectedTab = it }) },
            snackbarHost = { SnackbarHost(snackbarHostState) },
            containerColor = Color.Transparent
        ) { innerPadding ->
