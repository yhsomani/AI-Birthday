...
- Promotion by copying is forbidden. Production implementation requires a fresh review against the audited blueprint and current official documentation.

The React Native boundary probe has been deleted after its evidence was preserved in
`phase0/RN_NATIVE_BOUNDARY_SPIKE.md` and `phase0/PHASE0_EVIDENCE.md`. There are no active spikes.
